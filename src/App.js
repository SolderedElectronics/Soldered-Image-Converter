  ...
  return (
    <div className="App">
      <header className="App-header">
        <img src={logoPath} className="App-logo" alt="Soldered Image Converter Logo" />
      ...
      <main className="App-main">
        ...
        <img src={stepsPath} className="Steps-image" alt="Steps: 1. Upload, 2. Convert, 3. Upload" />
        ...
        <div className="Dropzone">
          ...
          <img src={dropIconPath} className="Dropzone-icon" alt="Drag and drop placeholder" />
